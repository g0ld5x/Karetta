...
std::string tokenTypeToString(TokenType type)
{
    switch (type)
    {
        ...
        case TokenType::isType: return "isType";

        case TokenType::Smaller:              return "<";
        case TokenType::SmallerEqual:         return "<=";
        case TokenType::Bigger:           return ">";
        case TokenType::BiggerEqual:      return ">=";
        ...
        case TokenType::UnaryNot:        return "!";

        case TokenType::BitLeft:         return "<<";
        case TokenType::BitRight:        return ">>";

        case TokenType::OpenParan:         return "(";
        case TokenType::CloseParan:        return ")";
        case TokenType::Comma:             return ",";
        case TokenType::StatementEnd:      return ";";
